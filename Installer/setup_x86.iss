...
OutputDir=.
OutputBaseFilename=ResourceAlchemyHacker_Installer_x86_1.4.0.5
Compression=lzma
...
[Files]
Source: "..\Release\ResourceAlchemyHacker_CLI.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ResourceAlchemyHacker_GUI.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ResourceAlchemyHacker_ShellExt.dll"; DestDir: "{app}"; Flags: regserver ignoreversion restartreplace uninsrestartdelete
